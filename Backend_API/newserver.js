...
/////////////////////////////////////____________-Hospital API-_________/////////////////////////////////////////////////



app.get('/hospital/profile/:hospitalId', async (req, res) => {
...
app.get('/hospital/hospitalinfo/:hospitalId', async (req, res) => {
    const hospitalId = req.params.hospitalId;
...
app.post("/hospital/Hospitallogin", async (req, res) => {
...
app.post('/hospital/send_otp', async (req, res) => {
    try {
...
app.post('/hospital/verify_otp', async (req, res) => {
...
app.get('/hospital/latest-appointment-id', async (req, res) => {
    try {
...
app.post("/hospital/submit-appointments", async (req, res) => {
    const {
        Contact_id,
        patientName,
        department,
...
app.get('/hospital/patients', async (req, res) => {
...
app.get('/hospital/departments/:hospitalId', async (req, res) => {
    const hospitalId = req.params.hospitalId;
    try {
        const pool = await sql.connect(config);
        const request = pool.request();
...
app.get('/hospital/doctorss', async (req, res) => {
    try {
...
app.get('/hospital/getappointment/:contactId', async (req, res) => {
    try {
...
app.delete('/hospital/appointment/delete/:id', async (req, res) => {
...
app.get('/hospital/departments/:dep_id', async (req, res) => {
...
app.put('/hospital/update-department/:dep_id', async (req, res) => {
    const { dep_id } = req.params;
...
app.post('/hospital/submit-department', async (req, res) => {
    try {
        await sql.connect(config);
...
app.get('/hospital/hdepartments/:hospitalId', async (req, res) => {
    const hospitalId = req.params.hospitalId;
    try {
        const pool = await sql.connect(config);
        const request = pool.request();
...
app.put('/hospital/updatedoctors/:id', upload.single('avatar'), async (req, res) => {
    const id = req.params.id;
    const {
        first_name,
        last_name,
...
app.post('/hospital/add-doctor', upload.single("avatar"), async (req, res) => {
    try {
...
app.delete('/hospital/doctors/delete/:id', async (req, res) => {
    const id = req.params.id;
...
app.get('/hospital/approved-doctors/:HospitalId', async (req, res) => {
...
app.get('/hospital/requested-hospitals', async (req, res) => {
    try {
        let pool = await sql.connect(config);
        const result = await pool.request().query(`
...
app.get('/hospital/requested-doctors/:hospitalId', async (req, res) => {
    const hospitalId = req.params.hospitalId;
...
app.post('/hospital/approve-doctor', async (req, res) => {
...
app.post('/hospital/reject-doctor', async (req, res) => {
    const { doctorID, hospitalID } = req.body;
...
app.get('/hospital/get-showdr', async (req, res) => {
    try {
        await sql.connect(config);
...
app.post('/hospital/request-doctor', async (req, res) => {
    const {
        role,
        experience,
        education,
...
app.put('/hospital/updatepatients/:pat_id', upload.single('avatar'), async (req, res) => {
...
app.post("/hospital/submit-formpatients", upload.single("avatar"), async (req, res) => {
    const {
        firstName,
        lastName,
        username,
...
app.get('/hospital/patients/:pat_id', async (req, res) => {
    const { pat_id } = req.params;
...
app.delete('/hospital/patients/delete/:pat_id', async (req, res) => {
...
////////////////////////////////////////__________-Dcotot API-__________/////////////////////////////////




app.post("/doctor/doctorlogin", async (req, res) => {
    const { email, password } = req.body;
...
app.post('/doctor/doctor/register', async (req, res) => {
    try {
        await sql.connect(config);
...
app.post('/doctor/verify_otp', async (req, res) => {
    const { email, otp } = req.body;
...
app.post('/doctor/send_otp', async (req, res) => {
    try {
        const { email } = req.body;
        const otp = generateOTP();
...
app.post("/doctor/change-password", async (req, res) => {
...
app.post('/doctor/changepassword/requestotp', async (req, res) => {
    const { email } = req.body;
...
app.post('/doctor/changepassword/verifyotp', async (req, res) => {
    const { email, otp } = req.body;
...
app.post('/doctor/changepassword', async (req, res) => {
...
app.get('/doctor/doctorinfo/:doctorId', async (req, res) => {
...
app.get('/doctor/doctorimage/:doctorId', async (req, res) => {
    const doctorId = req.params.doctorId;
    try {
        const pool = await sql.connect(config);
        const result = await pool.request()
...
app.put('/doctor/updatedoctor/:doctorId', async (req, res) => {
    const doctorId = req.params.doctorId;
...
app.get('/doctor/profile/:id/experience', async (req, res) => {
    const { id } = req.params;
...
app.get('/doctor/timetable/:doctorId', async (req, res) => {
...
app.post('/doctor/profile/experience', async (req, res) => {
...
app.put('/doctor/profile/updateexperience/:ExperienceID', async (req, res) => {
    const { doctorId, experience, period, title, hospital } = req.body;
...
app.post('/doctor/uploadImage', upload.single('image'), async (req, res) => {
    try {
        if (!req.file) {
...
app.get('/doctor/myhospitalsappointment/:doctorId', async (req, res) => {
    const { doctorId } = req.params;
    try {
        await sql.connect(config);
        const result = await sql.query`
...
app.get('/doctor/appointment-details/:appointmentId', async (req, res) => {
...
app.get('/doctor/latest-appointment-id', async (req, res) => {
    try {
...
app.post("/doctor/submit-appointments", async (req, res) => {
    const {
        Contact_id,
        patientName,
        department,
...
app.get('/doctor/myhospitals/:doctorId', async (req, res) => {
    const { doctorId } = req.params;
    try {
        await sql.connect(config);
        const result = await sql.query`
...
app.get('/doctor/myhos/:hospitalId', async (req, res) => {
    const { hospitalId } = req.params;
    try {
        await sql.connect(config);
        const result = await sql.query`
...
app.get('/doctor/booked-slots', async (req, res) => {
    try {
...
app.put('/doctor/update-appointment-status/:appointmentId', async (req, res) => {
...
app.put('/doctor/accept-appointment/:appointmentId', async (req, res) => {
    const { appointmentId } = req.params;
...
app.post("/doctor/delete-appointment", async (req, res) => {
...
app.get('/doctor/getappointment/:contactId', async (req, res) => {
    try {
        const { contactId } = req.params; // Get contactId from URL parameters
        let query = `
        SELECT A.*, D.first_name, D.last_name,D.avatar, DP.department_name
...
app.post('/doctor/save-event', async (req, res) => {
...
app.get('/doctor/events', async (req, res) => {
    try {
        await sql.connect(config);
...
app.get('/doctor/events/filter', async (req, res) => {
    try {
        await sql.connect(config);
...
app.get('/doctor/requested-Hospitals/:doctorId', async (req, res) => {
    const doctorId = req.params.doctorId;
...
app.get('/doctor/get-Hospital', async (req, res) => {
    try {
        await sql.connect(config);
...
app.get('/doctor/departments/:hospitalId', async (req, res) => {
    const hospitalId = req.params.hospitalId;
    try {
        const pool = await sql.connect(config);
        const request = pool.request();
...
app.post('/doctor/register-doctor', async (req, res) => {
    const {
...
app.get('/doctor/requested-hospitals', async (req, res) => {
    try {
        let pool = await sql.connect(config);
        const result = await pool.request().query(`
        SELECT * FROM Tbl_RequestHospital
...
////////////////////////////_________-Patient API-_____________///////////////////////////////////////////


app.post("/patient/logincust", async (req, res) => {
    const { email, password } = req.body;
  ...
  app.get('/patient/contact/:contactId', async (req, res) => {
  ...
  app.get('/patient/profile/:contact_id', async (req, res) => {
  ...
  app.delete('/patient/delete-patient/:patientID', (req, res) => {
  ...
  app.post('/patient/change-password', async (req, res) => {
  ...
  app.post('/patient/changepassword/requestotp', async (req, res) => {
    const { email } = req.body;
    const OTP = Math.floor(100000 + Math.random() * 900000); // Generate a 6-digit OTP
  ...
  app.post('/patient/changepassword/verifyotp', async (req, res) => {
    const { email, otp } = req.body;
...
app.post('/patient/changepassword', async (req, res) => {
  const { email, newPassword, otp } = req.body;
...
function generateOTP() {
  ...
  app.post('/patient/verify_otp', async (req, res) => {
    const { email, otp } = req.body;
  ...
  app.put('/patient/update-patient/:patientID', async (req, res) => {
  ...
  app.get('/patient/get-patients/:patientID', async (req, res) => {
    const patientID = req.params.patientID;
  ...
  app.post('/patient/send_otp', async (req, res) => {
    try {
        const { email } = req.body;
        const otp = generateOTP();
  ...
  app.get('/patient/appointment-details/:appointmentId', async (req, res) => {
    const appointmentId = req.params.appointmentId;
  ...
  app.get('/patient/latest-appointment-id', async (req, res) => {
    try {
  ...
  app.put("/patient/appointments/:id", async (req, res) => {
    const appointmentId = req.params.id;
    const {
      patientName,
      department,
  ...
  app.post("/patient/submit-appointments", async (req, res) => {
    const {
      Contact_id,
      patientName,
      department,
  ...
  app.get('/patient/getappointment/:contactId', async (req, res) => {
    try {
      const { contactId } = req.params; // Get contactId from URL parameters
      let query = `
        SELECT A.*, D.first_name, D.last_name,D.avatar, DP.department_name
  ...
  app.get('/patient/booked-slots', async (req, res) => {
    try {
      const { date, doctorId } = req.query;
      let query = `
        SELECT DISTINCT CONVERT(VARCHAR(5), time_slot, 108) AS formatted_time_slot 
  ...
  app.post("/patient/delete-appointment", async (req, res) => {
    const { AppointmentID } = req.body;
  ...
  app.get('/patient/get-Hospital', async (req, res) => {
    try {
      await sql.connect(config);
      const result = await sql.query`SELECT * FROM Tbl_HospitalProfile
      `;
