    ...
    routes: [
      {
        ...
        element: lazy(() => import('./views/dashboard/components/dashdoctor'))
      },
      {
        exact: 'true',
      ...
      {
        exact: 'ScheduleTiming',
        path: '/app/dashboard/ScheduleTiming',
        element: lazy(() => import('./layouts/Doctor-Shedule/calender'))
      },
      ...
      {
        exact: 'true',
        path: '/app/dashboard/Dr-Come-Request',
        element: lazy(() => import('./layouts/Hospital/components/comerequest'))
      },
      {
        exact: 'true',
        path: '/app/dashboard/Dr-Out-Request',
        element: lazy(() => import('./layouts/Hospital/components/outrequest'))
      },
      {
        exact: 'true',
        path: '/app/dashboard/Myhospitals',
        element: lazy(() => import('./layouts/Hospital/components/myhospitals'))
      },
      {
        exact: 'true',
