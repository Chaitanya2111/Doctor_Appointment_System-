...
const EnterEmailPage = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3005/patient/changepassword/requestotp", {
        method: "POST",
        headers: {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
        const response = await fetch("http://localhost:3005/patient/changepassword/verifyotp", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    const handleChangePassword = async (e) => {
        ...
        try {
          const response = await fetch("http://localhost:3005/patient/changepassword", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
