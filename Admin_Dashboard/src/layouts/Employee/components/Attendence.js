        ...
        <div className="container bg-white">
                <div className="row">
                    <div className="col-sm-12">
                        <div className="mt-3"><h4 className="page-title">Attendance Sheet</h4></div>
                    </div>
                </div>
                <div className="row filter-row">
                    <div className="col-sm-6 col-md-3">
                        <div className="form-group form-focus my-3">
                            <label className="focus-label">Employee Name</label>
                            <input type="text" className="form-control floating" />
                        </div>
                    </div>
                    <div className="col-sm-6 col-md-3">
                        <div className="form-group form-focus select-focus my-3">
                            ...
                            <table className="table table-striped custom-table mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><i className="fa fa-check text-success"></i> </td>
                                        <td><i className="fa fa-check text-success"></i> </td>
                                        <td><i className="fa fa-close text-danger fs-4">&times;</i> </td>
                                        <td><i className="fa fa-close text-danger fs-4">&times;</i> </td>
                                        <td><i className="fa fa-close text-danger fs-4">&times;</i> </td>
                                        <td><i className="fa fa-check text-success"></i> </td>
                                        <td><i className="fa fa-check text-success"></i> </td>
